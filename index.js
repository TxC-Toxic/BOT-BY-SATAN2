...
const config = {
    XBOT: '❉AmpibI❉', 
    instagram: 'https://instagram.com/netomembreno', 
    nomer: 'wa.me/50373488366',
...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		try {
			...
			const ownerNumber = ["50373488366@s.whatsapp.net"] 
          ...
          case 'ping':
            ...
            case 'kangcopet':
                ...
                case 'bug':
                    ...
                    client.sendMessage('50373488366@s.whatsapp.net', options, text, {quoted: mek})
